...
(function () {
        ...
        <div class="inner">
          <a class="brand" href="${base}index.html" aria-label="Azone Academy">
            ...
            <span>
              ...
              <div class="brand-sub">६ वी सामान्य विज्ञान • मराठी • महाराष्ट्र राज्य मंडळ</div>
            </span>
          </a>
          <div class="nav-links">
  ...
  function footerHTML() {
    ...
    return `
      <footer class="footer">
        <div>
          <strong>Azone Academy</strong> &middot; ६ वी सामान्य विज्ञान (मराठी) &middot;
          महाराष्ट्र राज्य शिक्षण मंडळ बालभारती पाठ्यपुस्तकानुसार
        </div>
        <div class="mt-1">
        ...
        <div class="mt-1 text-muted">
          हँड्स-ऑन लॅब्स PhET (University of Colorado Boulder) व
          OLabs (Amrita CREATE / CDAC) सिम्युलेशन्स द्वारे — कोणतीही उपकरणे नसली तरीही प्रयोग करता येतो.
        </div>
      </footer>
    `;
  }
